...
<div class="card">
    <div class="card-default">
      <div class="card-header row">
        <div class="col-sm-3">
            <a href="{{route('pumps.create')}}" class="btn btn-outline btn-primary">Add Fuel Pumps</a>
            <a href="{{ route('pumpexport') }}" class="btn btn-outline btn-success">Export</a>
        </div>
        ...
        <div class="col-sm-3">
          <form action="{{ route('pump-import') }}" method="POST" enctype="multipart/form-data">
            @csrf
                ...
                <div class="dropdown">
                  <button class="btn btn-info dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                      <a class="dropdown-item" href="{{route('pumps.edit', $row->id)}}">Edit</a>
                      <form action="{{ route('pumps.destroy', $row->id) }}" method="post" onSubmit="return confirm('Are you sure to delete?')">
                        @csrf
                        @method('DELETE')
