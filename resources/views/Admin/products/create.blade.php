      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active text-dark"><a href="{{URL('/admin/products/create')}}">Create Products</a></li>
          </ol>
        </div><!-- /.col -->
      </div><!-- /.row -->
    </div><!-- /.container-fluid -->
          ...
          <div class="col-sm-12">
            <div class="card">
              <div class=" card-header bg-primary">
               <h5><i class=" fas fa-plus-circle mr-3"></i>Create Products</h5>
             </div>
             <div class="card-body">                             
                ...
                <div class="card-body">
                  ...
                  <form action="{{route('products.store')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-10">
                        <input type="text" name="name" id="name" placeholder="Enter Product" class="form-control col-lg-6" required>
                      </div>
                    </div>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-8">
                       <div class="input-group">
                        <input type="Number" name="price" id="price" placeholder="Enter Price" class="form-control col-lg-7" required>
