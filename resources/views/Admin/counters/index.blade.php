...
<div class="card">
  <div class="card-default"> 
    <div class="card-header row">
        <div class="col-sm-3">
          <a href="{{route('counters.create')}}" class="btn btn-outline btn-primary">Add New Counters</a>
          <a href="{{ route('counterexport') }}" class="btn btn-outline btn-success">Export</a>
        </div>
        ...
        <div class="col-sm-3">
          <form action="{{ route('counterimport') }}" method="POST" enctype="multipart/form-data">
            @csrf
                ...
                <div class="dropdown">
                  <button class="btn btn-info dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                      <a class="dropdown-item" href="{{route('counters.edit', $row->id)}}">Edit</a>
                      <form action="{{ route('counters.destroy', $row->id) }}" method="post" onSubmit="return confirm('Are you sure to delete?')">
                        @csrf
                        @method('DELETE')
